...
const Footer = () => {
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    if (!email || !email.trim()) {
      setMessage({
        type: "error",
        text: t("emailRequired") || "Email is required",
      });
      return;
    }
    ...
    if (!emailRegex.test(email.trim())) {
      setMessage({
        type: "error",
        text: t("invalidEmail") || "Invalid email format",
      });
      return;
    }
    ...
    try {
      ...
      if (data.success) {
        setMessage({
          type: "success",
          text:
            t("newsletterSuccess") || "Successfully subscribed to newsletter!",
        });
      ...
      setMessage({
        type: "error",
        text: t("newsletterError") || "An error occurred. Please try again.",
      });
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <footer className="bg-[#f0f0f0]">
      ...
      <div className="bg-[#111] flex lg:flex-row flex-col items-start lg:items-center justify-center global-padding">
        <div className="bg-[#111] max-w-[1920px] flex-1 py-[32px] text-[#c7c7c7] text-[clamp(0.875rem,0.6528rem+0.3472vw,1rem)] font-semibold grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-[20px] text-center uppercase leading-[1.1]">
          {/* ICON BOX */}
        ...
        <div className="lg:flex-[1.4] flex-1 flex flex-col gap-10">
          <div className="max-w-[600px]">
            <div className="news-letter max-w-[600px] w-full flex flex-col gap-4">
              <h3 className="global-h1 font-bold leading-[0.9] tracking-tighter text-[#111] mb-5">
              ...
              >
                <div className="flex border border-[#111] rounded-[4px] relative">
                  ...
                  <button
                    ...
                    className={`w-full text-black font-semibold rounded-md flex-[50px_0_0] flex items-center justify-center ${
          ...
          <div className="w-full lg:p-0 p-4 lg:border-none border-b">
            <h3
              ...
              className="flex items-center lg:cursor-default cursor-pointer font-bold text-[18px] text-[#111] leading-[100%] uppercase mb-6"
            >
              {t("social")}
              <ChevronDown
                className={`inline ml-auto duration-300 transition-all ease-out lg:hidden block ${
                  third ? "rotate-180" : ""
                }`}
              />
            </h3>
            <ul
              ref={contentRef3}
              className="text-[16px] text-[#111] leading-[1.6] flex flex-col gap-2.5 lg:h-auto h-0 overflow-hidden font-normal"
            >
              {t.rich("li-social", {
      ...
      <div className="global-padding">
        <p className="text-[14px] font-bold pt-6 pb-6 global-border-top text-[#111] leading-[1.5] text-left">
          {t("copy")}
        </p>
      </div>
    </footer>
