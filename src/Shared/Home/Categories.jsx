    ...
    return (
        <section className="w-full">
            <div className="max-w-[1920px] mx-auto global-padding global-margin">
                {/* Title */}
                <h2 className="text-[42px] sm:text-[52px] leading-tight font-extrabold text-black mb-8 text-left">
                    Shop by category
                </h2>

                {/* Category grid */}
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 justify-center">
                    {categories.map((cat) => (
                        <Link
                            key={cat.name}
                            href={cat.path}
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute bottom-8 left-[20px] z-10">
