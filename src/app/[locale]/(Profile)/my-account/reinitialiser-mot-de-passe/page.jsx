"use client";
import { AlertCircle, ArrowUpRight, CheckCircle, Eye, EyeOff } from "lucide-react";
        ...
        <>
            {
                errorMessage.success === false && (
                    <div className='flex items-center gap-x-3 border-[#8b0000] border-2 py-4 px-8 mt-6 rounded-sm bg-[#F9F2F5] mb-10'>
                        <AlertCircle className='inline text-white fill-[#8b0000]' />
                        <p className='text-base leading-[100%] font-semibold text-[#8b0000]'>{errorMessage.error}</p>
                    </div>
                )
            }
            {
                errorMessage.success === true && (<div className='flex items-center gap-x-3 border-[#2A7029] border-2 py-4 px-8 mt-6 rounded-sm bg-[#FAFBF5]'>
