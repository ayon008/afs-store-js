        ...
        <div>
            <div className='space-y-[clamp(2.5rem,1.349rem+2.401vw,3.75rem)]'>
                ...
                <div className='space-y-[clamp(0.875rem,0.5297rem+0.7203vw,1.25rem)]'>
                    ...
                    <div className='space-y-[clamp(2.5rem,1.349rem+2.401vw,3.75rem)]'>
                        {/* 1st form */}
                        <FirstForm setMessage={setMessage} user={user} loading={loading} refreshUser={refreshUser} />
                        {/* 2nd form */}
                        <SecondForm setMessage={setMessage} user={user} loading={loading} refreshUser={refreshUser} />
                        {/* 3rd form */}
                        <ThirdForm setMessage={setMessage} user={user} loading={loading} refreshUser={refreshUser} />
                        {/* 4th Form */}
                        <ForthForm setMessage={setMessage} user={user} loading={loading} refreshUser={refreshUser} />
                    </div>
                </div>
            </div>
        </div>
