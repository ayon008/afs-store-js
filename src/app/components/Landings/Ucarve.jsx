...
---------------------------------------- */
        ...
        (context) => {
              ...
              heroImg,
              {
                ...
                y: () => {
                  ...
                  return (
                    ...
                    (heroBox.top +
                      window.scrollY +
                      heroBox.height / r(1.5, 1.5, 2))
                  );
                },

                width: () => aboutTarget.getBoundingClientRect().width,
                rotate: -10,
                scale: 1,
                opacity: 1,
          ...
          gsap
            ...
            .fromTo(
              ".hero_p",
              { x: -20, opacity: 0 },
              { x: 0, opacity: 1, stagger: 0.1, ease: "power1.inOut" },
              "<"
            )
            .fromTo(
              ".about_p",
              { y: 200, opacity: 0 },
              { y: 0, opacity: 1, stagger: 0.2, ease: "power1.inOut" },
              "<"
            );
          ...
          gsap
            ...
            .to(".flow_img_one", { scale: 1.5, ease: "Power1.easeInOut" }, "<");
          ...
          gsap
            ...
            .to(".sizes_inner", { rotate: -30, ease: "Power1.easeInOut" }, "<")
            .fromTo(
              ".sizes_img_I",
              { y: 0 },
              { y: 40, ease: "Power1.easeInOut" },
              "<"
            )
            .fromTo(
              ".sizes_img_II",
            ...
            .fromTo(
              ".sizes_img_III",
              { y: 0 },
              { y: 120, ease: "Power1.easeInOut" },
              "<"
            )
            .fromTo(
              ".sizes_img_IIII",
              { y: 0 },
              { y: 160, ease: "Power1.easeInOut" },
              "<"
            );
  ...
  return (
    <ReactLenis root options={{ autoRef: false }} ref={lenisRef}>
      <div className="bg-[#000]" ref={container}>
        <div ref={container} className="overflow-hidden max-w-[1920px] mx-auto">
          {/*hero*/}
          <section className="relative hero smooth global-padding global-margin">
            {/*hero top*/}
          ...
          <section className="whole global-padding md:py-30 py-20 mx-auto flex flex-col lg:flex-row md:gap-[clamp(1.5rem,-5.1756rem+13.9256vw,8.75rem)] gap-4">
          ...
          <section className="short smooth mb-10 md:mb-20 lg:mb-30">
            {/* top text */}
            <div className="short_t_div smooth flex flex-col text-white items-end gap-6 md:gap-10 global-padding relative z-1">
          ...
          <section className="relative global-padding max-w-[1440px] mx-auto global-margin">
