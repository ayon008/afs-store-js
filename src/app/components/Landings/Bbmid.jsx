...
const Bbmid = () => {
  ...
  const heroContent = {
    title: t("Hero_t"),
    image: {
      src: `${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/BBML_10-1.png`,
      width: 800,
      height: 600,
      alt: "BBML Graphic",
      className:
  ...
  const aboutContent = {
    left: t("about_h"),
    right: {
      heading: t("Long_version"),
      intro: t("about_intro"),
      details: [t("about_p"), t("about_p_i")],
    },
  };

  /* ----------------------------------------
   Lenis for GSAP smooth animations (smoother)
---------------------------------------- */
  useEffect(() => {
...
---------------------------------------- */
  ...
  useGSAP(
          ...
          if (activeTab === 0) {
            ...
            gsap
              ...
              .fromTo(
                ".about_right_p",
                { y: 120 },
                { y: 0, stagger: r(0.15, 0.12, 0.1), ease: "Power1.out" },
                "<"
              );
    ...
    { scope: container, dependencies: [activeTab] } // <-- watch activeTab
  );
  ...
  return (
    <ReactLenis root options={{ autoRef: false }} ref={lenisRef}>
      ...
      ====================== */}
          ...
          <div className="smooth relative max-w-[1920px] mx-auto">
            ...
            <section className="smooth about_2 relative overflow-hidden bg-no-repeat bg-cover bg-center min-h-[calc(100vh-60px)] global-padding py-[120px]">
              ...
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/PP_BB_B_0006-5.png)`,
                }}
              ></div>
              <div className="flex flex-col gap-[50px] max-w-[1195px]">
                ...
                <div className="about_2_P flex flex-col gap-[20px]">
                  ...
                  <div className="about_2_P pt-[30px] border-t-2 border-[#D44841] text-white flex flex-wrap gap-[clamp(1.5rem,-1.7227rem+6.7227vw,5rem)] max-w-[1060px] font-semibold leading-[1.3]">
                    <p className="md:flex-[1] flex-[100%]">{t("Featuring")}</p>
              ...
              <div className="horizontal-wrapper flex h-full">
                ...
                <div className="smooth panel panel_two flex-shrink-0 lg:w-[200%] w-[1800px] flex items-center justify-center text-white text-4xl flex flex-nowrap py-10">
                  ...
                  <div className="smooth min-w-1/2 global-padding panel_inner_one relative z-1">
                    <p className="smooth hori_two_p_tow pl-[20px] border-l border-l-[2px] border-l-[#D44841] max-w-[250px] text-[20px] text-[#FFFFFFCC] font-semibold ml-[75%] relative z-1">
                      {t("Enhanced")}
                    </p>
                    <Image
                      src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/PP_BB_CF_0007-2.png`}
                      width={800}
                      alt="BBML Graphic"
                      height={600}
                  ...
                  <div className="smooth min-w-1/2 global-padding panel_inner_two">
                    <p className="smooth pl-[20px] border-l border-l-[2px] border-l-[#D44841] max-w-[250px] text-[20px] text-[#FFFFFFCC] font-semibold ml-[75%] -mb-[100px] relative z-1">
                      {t("Inspired")}
                    </p>
                    <Image
                      src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/PP_BB_B_0007-4.png`}
                      width={800}
                      alt="BBML Graphic"
                      height={600}
                      style={{ width: "100%", height: "auto" }}
                      className="smooth min-w-[100%] scale-[1] hori_img_two"
                      // onLoadingComplete={(img) => handleImageLoad(img)}
                    />
            ...
            {/* Experience_section */}
            <section className="smooth expo_sec min-h-[calc(100vh-50px)] mt-[80px] flex flex-col lg:flex-row overflow-hidden">
              <div className="lg:w-1/2 w-[100%] overflow-hidden min-h-[calc(50vh-25px)]">
                <Image
                  src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/PP_BB_B_0006-6.png`}
                  width={800}
                  alt="BBML Graphic"
                  height={600}
                  style={{ width: "100%", height: "auto" }}
              ...
              <div className="smooth lg:w-1/2 w-full bg-[#F7F7F7] global-padding flex items-end py-10 min-h-[calc(50vh-25px)]">
            ...
            <section className="smooth although relative max-w-[1920px] global-padding flex min-h-[calc(100vh-50px)] mx-auto text-center text-white flex items-center font-bold flex-col global-margin overflow-hidden">
              ...
              <Image
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/BBML_06-1.png`}
                width={800}
                alt="BBML Graphic"
                height={600}
        ...
        {activeTab === 1 && (
          ...
          <div className="relative max-w-[1920px] mx-auto">
            ...
            <section className="hero_ii  pb-[80px] lg:pb-[clamp(7.5rem,-1.3889rem+13.8889vw,12.5rem)] bg-[linear-gradient(268.11deg,_#000000_0%,_#1F1F1F_100%)]">
              <Image
                src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/FRONTTAIL-TRANSPARENT-1.png`}
                width={800}
                height={600}
                alt="BBML Graphic"
              ...
              <div className="mx-auto text-white relative z-1 lg:-mt-[200px] mt-[0] flex flex-col gap-[50px] global-padding">
                ...
                <div className="hero_ii_p_div border-t border-t-[2] border-t-[#6CC9E6] flex flex-col lg:flex-row gap-[50px] pt-[50px] text-[22px] leading-[1.3] font-semibold text-[#FFFFFFCC]">
                  <p className="flex-1">{t("standout")}</p>
                  <p className="hero_ii_p flex-1">{t("pvc")}</p>
                  <p className="hero_ii_p_ii flex-1">{t("Refreshed")}</p>
                </div>
              </div>
            </section>
            ...
            <section className="about_ii global-margin">
              ...
              <div className="about_ii_inner_i flex lg:text-[22px] text-4 leading-[1.3] font-semibold text-[#FFFFFFCC] text-center flex-col md:flex-row">
                <div className="flex-1 overflow-hidden">
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/DSC01362-Recupere-2.png`}
                    width={800}
                    height={600}
                    alt="BBML Graphic"
                    style={{ width: "100%" }}
                ...
                <div className="flex items-center justify-center flex-1 overflow-hidden">
                  <p className="about_ii_inner_i_p max-w-[600px] p-[40px]">
                    {t.rich("about_blackbird_midlength", {
                      highlight: (chunks) => (
                        <span className="text-[#6CC9E6]">{chunks}</span>
                      ),
                    })}
                  </p>
                </div>
              ...
              <div className="about_ii_inner_i flex lg:text-[22px] text-4 leading-[1.3] font-semibold text-[#FFFFFFCC] text-center flex-col md:flex-row bg-[#111111]">
                <div className="flex-1 overflow-hidden">
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/DSC01362-Recupere-3.png`}
                    width={800}
                    height={600}
                    alt="BBML Graphic"
                    style={{ width: "100%" }}
              ...
              <div className="about_ii_inner_i flex lg:text-[22px] text-4 leading-[1.3] font-semibold text-[#FFFFFFCC] text-center flex-col md:flex-row bg-[#1F1F1F]">
                <div className="flex-1 overflow-hidden">
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/Frame-65.png`}
                    width={800}
                    height={600}
                    alt="BBML Graphic"
                    style={{ width: "100%" }}
            ...
            <section className="key global-margin global-padding space-y-[60px]">
              <h2 className="global-h2 text-center text-white">
                {t("Key features")}
              </h2>
              {/* key main  */}
        ...
        {/* Sized chart */}
        <section className="sized smooth size_chart global-padding max-w-[1920px] mx-auto text-white global-margin flex flex-col gap-[20px]">
            ...
            <div className="smooth grid grid-cols-2 lg:gap-[90px] gap-10 text-center md:grid-cols-4 justify-between w-[100%]">
              ...
              <div className="smooth size_box flex flex-col gap-10 flex-[1_0_0] max-w-[320px]">
                <div className="smooth flex items-center justify-center">
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/PP_BB_CF_0009-3.png`}
                    width={800}
                    alt="BBML Graphic"
                    height={600}
                    style={{ width: "100%", height: "auto" }}
                  ...
                  />
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/BBML_06-1-1.png`}
                    width={800}
                    alt="BBML Graphic"
                    height={600}
                    style={{ width: "100%", height: "auto" }}
              ...
              <div className="smooth size_box flex flex-col gap-10 flex-[1_0_0] max-w-[320px]">
                <div className="smooth flex items-center justify-center">
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/PP_BB_CF_0009-4.png`}
                    width={800}
                    alt="BBML Graphic"
                    height={600}
                    style={{ width: "100%", height: "auto" }}
              ...
              <div className="smooth size_box flex flex-col gap-10 flex-[1_0_0] max-w-[320px]">
                <div className="flex items-center justify-center">
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_URL}/wp-content/uploads/2026/02/PP_BB_CF_0009-5.png`}
                    width={800}
                    alt="BBML Graphic"
                    height={600}
                    style={{ width: "100%", height: "auto" }}
        ...
        <div
          ref={navRef}
          className="b_nav fixed bottom-6 left-1/2 -translate-x-1/2 z-50 overflow-hidden rounded-full bg-[#1F1F1F] w-fit"
        >
          <div
            ref={bgRef}
            ...
            {tabs.map((tab, index) => (
              <button
                ...
                onClick={() => {
                  ...
                  // Kill old GSAP scroll triggers
                  ScrollTrigger.getAll().forEach((t) => t.kill());

                  const heroEl =
                    document.getElementsByClassName("hero_div_m")[0];
                  if (!heroEl) return;

                  // Scroll to hero section using Lenis
                  if (lenisRef.current?.lenis) {
                    lenisRef.current.lenis.scrollTo(heroEl, {
                      immediate: true,
                    });
                  } else {
                ...
                className={`cursor-pointer relative z-10 px-5 py-3 rounded-full text-sm font-semibold uppercase transition-colors ${
